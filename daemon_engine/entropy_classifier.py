...
def gerar_aleatoria(n_fitas, n_ciclos):
    """Gera dados de entropia para um estado aleatório."""
    base = 1.98
    return base + np.random.normal(0, 0.005, size=(n_fitas, n_ciclos))

def gerar_pulso(n_fitas, n_ciclos):
    """Gera dados de entropia para um estado de pulso."""
...
def gerar_ruido(n_fitas, n_ciclos):
    """Gera dados de entropia para um estado ruidoso."""
...
if __name__ == '__main__':
    print("Acurácia do Classificador de Entropia:", clf.score(Xte, yte))
    print("\nMatriz de Confusão:")
